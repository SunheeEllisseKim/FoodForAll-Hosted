...
class DonationSerializer(serializers.ModelSerializer):
    class Meta:
        model=Donation
        fields=('DonationID', 'DonationName', 'DonationAllergies', 'DonationFoodBank', 'DonorEmail', 'DonorAddress', 'DonorZipCode', 'DonationQuantity', 'DonationDeliveryStatus', 'DonationDriver')
